...
var maximize_window = function() {
    callDBus("org.kde.kglobalaccel", "/component/kwin", "org.kde.kglobalaccel.Component", "invokeShortcut", "Window Maximize");
}
...
function init() {
    ...
    for (var i in borders) {
        ...
        if (isFinite(border)) {
            ...
            registerScreenEdge(border, maximize_window);
        }
    }
}
